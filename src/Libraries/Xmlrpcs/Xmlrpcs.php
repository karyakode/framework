<?php namespace Kodhe\Pulen\Libraries\Xmlrpcs;
...
if ( ! class_exists('Kodhe\Pulen\Libraries\Xmlrpc\Xmlrpc', FALSE))
{
 ...
 */
class Xmlrpcs extends \Kodhe\Pulen\Libraries\Xmlrpc\Xmlrpc {
